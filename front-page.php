...
<section id="hero" class="min-h-[100svh] flex flex-col md:flex-row w-full relative bg-white">
    ...
    <div class="w-full h-[55vh] md:w-[40%] md:h-auto bg-dark-bg relative flex items-end justify-center overflow-hidden">
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[150%] h-[80%] border border-white/10 rounded-[100%] rotate-12 pointer-events-none"></div>
        
        <!-- Арка фото -->
        <div class="relative z-10 w-full h-full flex items-end justify-center pb-0 px-6 md:px-4">
            <div class="relative overflow-hidden w-full max-w-sm md:max-w-md h-[90%] md:h-[85%] rounded-t-[10rem] md:rounded-t-full border-t border-x border-white/20 shadow-2xl">
    ...
    <div class="w-full md:w-[60%] bg-white flex flex-col justify-center px-6 py-8 md:p-16 lg:p-24 relative flex-grow">
        ...
        <div class="max-w-2xl mx-auto md:mx-0 w-full">
            ...
            <div class="mb-6 md:mb-8 fade-in-up relative text-center md:text-left">
                <h1 class="text-3xl xs:text-4xl md:text-5xl lg:text-6xl tracking-[0.1em] uppercase font-serif text-gray-900 leading-tight">
            ...
            <div class="flex items-center justify-center md:justify-start gap-4 mb-8 fade-in-up delay-200">
                ...
                <p class="text-[10px] xs:text-xs md:text-sm tracking-[0.2em] md:tracking-[0.3em] uppercase text-gray-500 font-semibold text-center md:text-left">
            ...
            <!-- Socials (Images) -->
            <?php if($socials): ?>
            <div class="flex justify-center md:justify-start space-x-6 md:space-x-8 mb-10 fade-in-up delay-200 items-center">
                <?php foreach($socials as $social): ?>
                    <?php if(!empty($social['url']) && !empty($social['icon_image'])): ?>
                    <a href="<?php echo esc_url($social['url']); ?>" target="_blank" class="hover:scale-110 transition duration-300 opacity-60 hover:opacity-100">
                        <img src="<?php echo esc_url($social['icon_image']); ?>" alt="Social Icon" class="h-6 md:h-8 w-auto object-contain">
                    </a>
                    <?php endif; ?>
                <?php endforeach; ?>
            </div>
...
<section id="payment-section" class="min-h-screen bg-beige-bg flex flex-col items-center justify-center text-center p-6 md:p-8 relative border-t border-white/50">
    ...
    <div class="max-w-4xl w-full relative z-10" data-aos="fade-up">
        ...
        <div class="flex flex-col items-center gap-6">
            ...
            <div class="relative group w-full max-w-xs md:max-w-xl mt-4">
                <div class="absolute -inset-1 bg-gradient-to-r from-gray-200 to-gray-400 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
                <!-- UPDATED SIZE CLASSES -->
                <button id="pay-button" class="relative w-full bg-black text-white px-8 py-5 md:px-12 md:py-6 text-xs md:text-base tracking-[0.2em] uppercase font-sans font-bold hover:bg-gray-800 transition-all duration-300 shadow-2xl">
        ...
        <p class="mt-12 text-[10px] uppercase tracking-widest text-gray-400 max-w-xs md:max-w-md mx-auto leading-relaxed">
